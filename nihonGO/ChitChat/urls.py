...
urlpatterns = [
    ...
    path("private_chat/<int:friend_id>/", views.private_chat, name='private_chat_room'),
    path('search/', views.search_rooms, name='search_rooms'),  # New search view
    path('join/<int:room_id>/', views.join_room, name='join_room'),  # New join room view
    path('leave/<int:room_id>/', views.leave_room, name='leave_room'),  # New leave room view
]
